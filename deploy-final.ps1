# Script de déploiement final corrigé pour Windows
Write-Host "🚀 Déploiement Vercel - Version Finale" -ForegroundColor Green
...
# Corriger le fichier vercel.json du frontend
Write-Host "`n🔧 Correction du fichier vercel.json..." -ForegroundColor Blue
$vercelJsonContent = @"
{
  "version": 2,
  "builds": [
...
$vercelJsonContent | Out-File -FilePath "frontend-service\vercel.json" -Encoding UTF8
Write-Host "✅ Fichier vercel.json corrigé" -ForegroundColor Green
