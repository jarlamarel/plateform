# Script de correction pour l'affichage des cours
Write-Host "🔧 Correction de l'affichage des cours" -ForegroundColor Green
...
Write-Host "   - API_URL pointe vers REACT_APP_CONTENT_API_URL" -ForegroundColor White
Write-Host "   - Routes corrigées pour utiliser /content/courses" -ForegroundColor White
Write-Host "   - URL finale: http://localhost:3003/api/content/courses" -ForegroundColor White
